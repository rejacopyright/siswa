  ...
  render() {
    return (
      <div className={this.props.divClass}>
        ...
        <textarea onChange={this.value.bind(this)} value={this.state.value} name={this.props.name} rows={this.props.rows} className={"form-control form-control-sm radius-5 oa bg-light " + this.props.className} autoComplete="off" spellCheck={false} placeholder={this.props.placeholder} readOnly={this.props.readOnly} />
