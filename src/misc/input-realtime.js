    ...
    return (
      <div className={this.props.divClass}>
        ...
        <div className="position-absolute r-1 bg-white radius-20 px-1 text-danger bold f-8 m-0" style={{top:'8px'}}>{ this.state.error }</div>
          <div className="input-realtime">
            <input onChange={this.value.bind(this)} value={this.state.value} type="text" name={this.props.name} className={this.props.className} autoComplete="off" spellCheck={false} placeholder={this.props.placeholder} readOnly={this.props.readOnly} />
