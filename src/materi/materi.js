...
class Materi extends React.Component {
  ...
  componentDidMount() {
    ...
    .then(res => {
      ...
      this.setState({ materi:res.data.materi, fLoading:false, cLoading:false, mapel:mapel });
    });
  }
  mapelChange(val){
    this._isMounted && this.setState({ cLoading:true });
    ...
    .then(res => {
      this.setState({ materi:res.data.materi, cLoading:false });
    });
  }
  render () {
    return(
                    ...
                    <div className="card h-100 no-b shadow-xs">
                      <div className="card-body pb-4">
                        ...
                        <div className="position-absolute d-flex align-items-center w-100 b-0 r-0 mb-2">
                          ...
                          <p className="mb-0 mr-2 f-8 text-nowrap"><Rating emptySymbol="la la-star la-lg" fullSymbol="la la-star la-lg text-warning" fractions={2} readonly initialRating={3.5} /> <span className="ml-2 strong">7/10</span></p>
